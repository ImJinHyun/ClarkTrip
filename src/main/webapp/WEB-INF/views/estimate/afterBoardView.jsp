...
<div style="position: relative;	left: 500px; width:50%; display:none" id="action">
작성자 id : <input value="${view.id}"><br>
등록일 : <input value="<fmt:formatDate value="${view.reg_dt}" pattern="yyyy-MM-dd HH:MM:SS"/>"><br>
<button type="button" class="btn btn-info btn-sm" onclick="act();">변경</button>
...
function action() {
    ...
    var objDiv = document.getElementById("action");
		...
		$.ajax({
		    ...
		    success: function(data){
					...
					if(data.cd == "idCheck") {
						...
						alert("게시글이 삭제되었습니다.");			
						location.href="/community/afterBoardList";	
					}
		    },
...
function update(){
location.href= "/community/afterBoardUpdate.do?board_no="+"${view.board_no}"
}
</script>
                                <hr>
