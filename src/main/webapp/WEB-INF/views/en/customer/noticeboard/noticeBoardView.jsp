	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <p class="text-black"><a href="/EN" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;Notice</p>
...
<div class="container">
				...
				function update(){
				location.href= "/customer/noticeBoardUpdate?board_no="+"${view.board_no}"
				}
				</script>
                                <hr>
                                ...
                                <a class="btn type--uppercase btn-more-view btn-80" href="noticeBoardView?board_no=${view.board_no-1 }">
                               	...
                               	<a class="btn type--uppercase btn-more-view btn-80" href="/customer/noticeBoardList">
                                   	<span class="btn__text">
                                       	List
                                       </span>
                                   </a>
