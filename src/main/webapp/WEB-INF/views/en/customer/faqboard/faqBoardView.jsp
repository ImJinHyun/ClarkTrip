	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <p class="text-black"><a href="/EN" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;FAQ</p>
...
<div class="container">
						...
						$.ajax({
						    ...
						    success: function(data){
									...
									if(data.cd == "idCheck") {
										...
										alert("게시글이 삭제되었습니다.");			
										location.href="/customer/faqBoardList";	
									}
						    },
				...
				function update(){
				location.href= "/customer/faqBoardUpdate?board_no="+"${view.board_no}"
				}
				</script>
                                <hr>
                                ...
                                <a class="btn type--uppercase btn-more-view btn-80" href="faqBoardView?board_no=${view.board_no-1 }">
                               	...
                               	<a class="btn type--uppercase btn-more-view btn-80" href="/customer/faqBoardList">
                                   	<span class="btn__text">
                                       	List
                                       </span>
                                   </a>
