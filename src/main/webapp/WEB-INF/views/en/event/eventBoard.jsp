	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>Event</h1>
	            <p class="text-black"><a href="/EN" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;Current Event</p>
	      ...
	      <div class="container">
			<h2>Current Event</h2>
			  ...
			  <br>
				...
				<a href="/event/eventBoardWrite"><button class="btn btn-info btn-sm" >Write</button></a>
	      </div>
</div>
