	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>Community</h1>
	            <p class="text-black"><a href="/EN" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;Videos</p>
	      ...
	      <div class="container">
			<h2>Videos</h2>
			  ...
			  <br>
				...
				<a href="/community/movieBoardWrite"><button class="btn btn-info btn-sm" >Write</button></a>
	      </div>
</div>
