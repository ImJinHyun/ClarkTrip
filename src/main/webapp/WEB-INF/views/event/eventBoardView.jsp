...
<div class="container">
						...
						$.ajax({
						    ...
						    success: function(data){
									...
									if(data.cd == "idCheck") {
										...
										alert("게시글이 삭제되었습니다.");			
										location.href="/customer/eventBoardList";	
									}
						    },
				...
				function update(){
				location.href= "/customer/eventBoardUpdate?board_no="+"${view.board_no}"
				}
				</script>
                                <hr>
                                ...
                                <a class="btn type--uppercase btn-more-view btn-80" href="eventBoardView?board_no=${view.board_no-1 }">
                               	...
                               	<a class="btn type--uppercase btn-more-view btn-80" href="/customer/eventBoardList">
                                   	<span class="btn__text">
                                       	List
                                       </span>
                                   </a>
