...
<form action="/eventBoardWrite.do" method="post"  id="frm">
...
<div class="site-section bg-light custom-border-bottom" data-aos="fade" >
	      <div class="container">
		      ...
		      <div class="row">
			        <div class="col-sm-2">Event Y/N</div>
			        <div class="col-sm-10 ">
			        <div class="form-check-inline"><label class="form-check-label"><input type="radio" class="form-check-input" name="event_Yn" value="Y" checked="${view.event_Yn == 'Y' ? checked : '' }">Y  </label></div>
			        <div class="form-check-inline"><label class="form-check-label"><input type="radio" class="form-check-input" name="event_Yn" value="N" checked="${view.event_Yn == 'N' ? checked : '' }">N</label></div>
  					</div>
		      </div>
		      <br>
		      <div class="row">
