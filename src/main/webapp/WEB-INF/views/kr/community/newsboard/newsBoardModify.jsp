	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>커뮤니티</h1>
	            <p class="text-black"><a href="/" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;회사뉴스</p>
	    		
	          </div>
	        </div>
	      </div>
</div>
<form action="./newsBoardUpdate.do" method="post"  id="frm">
