	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>커뮤니티</h1>
	            <p class="text-black"><a href="/" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;관련 동영상</p>
			...
			<h2>관련 동영상</h2>
			  ...
			  <table class="table table-hover">
			    ...
			    <tbody>
					...
					<td ><a href="/movieBoardView?board_no=${node.board_no }">${node.subject}</a></td>
					</tr>
					</c:forEach> 
			    </tbody>
			  </table>
			  <br>
				...
				<a href="/community/movieBoardWrite"><button class="btn btn-info btn-sm" >글쓰기</button></a>
	      </div>
</div>
