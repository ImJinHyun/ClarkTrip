	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>이벤트</h1>
	            <p class="text-black"><a href="/" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;진행중인 이벤트</p>
	      ...
	      <div class="container">
			<h2>진행중인 이벤트</h2>
			  ...
			  <br>
				...
				<a href="/event/eventBoardWrite"><button class="btn btn-info btn-sm" >글쓰기</button></a>
	      </div>
</div>
