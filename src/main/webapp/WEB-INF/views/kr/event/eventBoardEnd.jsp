	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>이벤트</h1>
	            <p class="text-black"><a href="/" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;종료된 이벤트</p>
	      ...
	      <div class="container">
			<h2>종료된 이벤트</h2>
			  ...
			  <br>
				...
				<a href="/event/eventBoardWrite"><button class="" >글쓰기</button></a>
	      </div>
</div>
