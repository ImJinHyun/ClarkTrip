	      ...
	      <div class="container">
	        <div class="row mb-5">
	          ...
	          <div class="col-md-5 mr-auto">
	            ...
	            <h1>회원가입</h1>
	            <p class="text-black"><a href="/" style="">Home</a>&nbsp;&nbsp;<span class="icon-chevron-right" style="font-size:10px"></span>&nbsp;&nbsp;회원가입</p>
	...
	<div class="site-section custom-border-bottom" data-aos="fade" >
        ...
        <div class="p-3 p-lg-5 border">
            <div class="form-group">
                <label for="provision" class="text-black">회원가입약관</label>
                    <textarea class="form-control" rows="8" style="resize:none">
약관동의
                    </textarea>
                    <div class="col-md-12">
                        <label class="text-black" style="margin-left:10px;">
                            <input type="radio" class="form-check-input" id="provisionYn" name="provisionYn" value="Y" checked>
                            동의합니다.
                        </label>
                        <br>
                        <label class="text-black" style="margin-left:10px;">
                            <input type="radio" class="form-check-input" id="provisionYn" name="provisionYn" value="N">
                            동의하지 않습니다.
                        </label>
                    </div>
            </div>
            <div class="form-group">
                <label for="memberInfo" class="text-black">개인정보취급방침</label>
                    <textarea class="form-control" rows="8" style="resize:none">
						개인정보의 항목 및 수집방법
                    </textarea>
                    <div class="col-md-12">
                        <label class="text-black" style="margin-left:10px;">
                            <input type="radio" class="form-check-input" id="memberInfoYn" name="memberInfoYn" value="Y" checked>
                            동의합니다.
                        </label>
                        <br>
                        <label class="text-black" style="margin-left:10px;">
                            <input type="radio" class="form-check-input" id="memberInfoYn" name="memberInfoYn" value="N">
                            동의하지 않습니다.
                        </label>
                    </div>
            </div>
            ...
            <div class="form-group row">
                  <div class="col-md-12">
                	<label for="inputId" class="text-black">아이디 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row" id="divPassword">
                <div class="col-lg-12">
                <label for="inputPassword" class="text-black">패스워드 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row" id="divPasswordCheck">
                <div class="col-lg-12">
                <label for="inputPasswordCheck" class="text-black">패스워드 확인 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row" id="divName">
                <div class="col-lg-12">
                <label for="inputName" class="text-black">이름 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row" id="divEmail">
                <div class="col-lg-12">
                <label for="inputEmail" class="text-black">이메일 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row" id="divTEL">
                <div class="col-lg-12">
                <label for="inputTEL" class="text-black">휴대폰 번호 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                <label for="inputTEL" class="text-black">성별 <span class="text-danger">*</span></label>
            ...
            <div class="form-group row" >
                <div class="col-lg-12">
                <label for="addrFull" class="text-black">배송지주소 </label>
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                <label for="inputTEL" class="text-black">배송지 ZIP CODE(우편번호)</label>
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                <label for="inputEmailReceiveYn"class="text-black">이메일 수신여부</label>
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                <label for="inputTEL"class="text-black">SMS 수신여부</label>
                    <label class="radio-inline">
            ...
            <div class="form-group row">
                <div class="col-lg-offset-2 col-lg-10">
                    <button type="button" id="submit" class="btn btn-default" onclick="join();">Sign in</button>
                </div>
            </div>`
